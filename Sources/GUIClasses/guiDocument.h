...
public:
    ...
    virtual u32 getType()
    {
        return guiObject::getType() | GOTYPE_DOCUMENT;
    };
    ...
    {
        return (guiComponent*) m_pComponentsList->getFirst(m_iCpntIt2);
    };
    guiComponent * getNextComponent()
    {
        return (guiComponent*) m_pComponentsList->getNext(m_iCpntIt2);
    };
    guiComponent * getLastComponent()
    {
        return (guiComponent*) m_pComponentsList->getLast(m_iCpntIt2);
    };
    guiComponent * getPrevComponent()
    {
        return (guiComponent*) m_pComponentsList->getPrev(m_iCpntIt2);
    };
    int getComponentsCount()
    {
        return m_pComponentsList->size;
    };
    ...
    ObjectList * getComponentsList()
    {
        return m_pComponentsList;
    };
    ...
    void setOwner(guiContainer * pOwner)
    {
        m_pOwner = pOwner;
    };

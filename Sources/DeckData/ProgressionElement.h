...
{
public:
  ProgressionEffect_Charac(char * sKey, int iMod) { wsafecpy(m_sKey, NAME_MAX_CHARS, sKey); m_iModifier = iMod; };
...
{
public:
  ProgressionEffect_Spell(char * sEdition, char * sName) { wsafecpy(m_sSpellEdition, NAME_MAX_CHARS, sEdition); wsafecpy(m_sSpellName, NAME_MAX_CHARS, sName); };
...
{
public:
  ProgressionEffect_Skill(char * sEdition, char * sName, char * sParams) { wsafecpy(m_sSkillEdition, NAME_MAX_CHARS, sEdition); wsafecpy(m_sSkillName, NAME_MAX_CHARS, sName); wsafecpy(m_sSkillParameters, NAME_MAX_CHARS, sParams); };
...
{
public:
  ProgressionEffect_Artifact(char * sEdition, char * sName) { wsafecpy(m_sArtifactEdition, NAME_MAX_CHARS, sEdition); wsafecpy(m_sArtifactName, NAME_MAX_CHARS, sName); };
...
{
public:
  ProgressionEffect_Avatar(char * sEdition, char * sName) { wsafecpy(m_sAvatarEdition, NAME_MAX_CHARS, sEdition); wsafecpy(m_sAvatarName, NAME_MAX_CHARS, sName); };

...
childEffectsIcon = {"shamandefender"}
icon = "shamandefender"

function getName()
	if language == "french" then
		return "Défenseur des shamans"
	else
		return "Shaman defender"
	end
end
...
function getDescription()
	if language == "french" then
		return "Augmente de 2 l'endurance de tous les shamans Mawohkas sur la même case."
	else
		return "Increases by 2 endurance of all Mawohkas shamans on the same tile."
	end
end

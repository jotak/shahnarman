...
public:
  ...
  public:
    ...
    virtual bool isAt(int xPxl, int yPxl) { int w = m_iWidth; m_iWidth = m_iBoxWidth; bool b = guiLabel::isAt(xPxl, yPxl); m_iWidth = w; return b; };
  ...
  InputButton getActionOnSelection() { InputButton action = m_ActionOnSelection; m_ActionOnSelection = (InputButton)0; return action; };
  ...
  int count() { return getDocument()->getComponentsList()->size; };

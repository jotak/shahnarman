...
public:
    ...
    Edition * getFirstEdition()
    {
        return (Edition*) m_pEditions->getFirst(0);
    };
    Edition * getNextEdition()
    {
        return (Edition*) m_pEditions->getNext(0);
    };
    Profile * findProfile(const char * sName);
    Profile * getFirstProfile()
    {
        return (Profile*) m_pAllProfiles->getFirst(0);
    };
    Profile * getNextProfile()
    {
        return (Profile*) m_pAllProfiles->getNext(0);
    };

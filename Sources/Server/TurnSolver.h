...
public:
    ...
    SpellsSolver * getSpellsSolver()
    {
        return m_pSpellsSolver;
    };
    AISolver * getAISolver()
    {
        return m_pAISolver;
    };
    ...
    {
        return m_pCurrentUnit;
    };  // Actually the same as getCurrentUnit, but for conveniance we keep that
    Unit * getDefender()
    {
        return m_pDefendingUnit;
    };

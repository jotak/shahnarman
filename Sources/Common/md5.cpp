...
/* local functions */
static void md5_memcopy (unsigned char *, const unsigned char *, const unsigned int);
...
///* OBSOLETE */
static void md5_memcopy (unsigned char *dest, const unsigned char *src, const unsigned int count)
{
    unsigned int i;

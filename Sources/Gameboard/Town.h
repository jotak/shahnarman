...
public:
    ...
    virtual u32 getType()
    {
        return MapObject::getType() | GOTYPE_TOWN;
    };
    ...
    {
        snprintf(m_sIdentifiers, 16, "town %d %ld", (int) m_uOwner, (long) m_uTownId);
    };
    ...
    char * getEthnicityEdition()
    {
        return m_sEthnicityEdition;
    };
    char * getEthnicityId()
    {
        return m_sEthnicityId;
    };
    u8 getSize()
    {
        return m_uSize;
    ...
    u16 getFoodInStock()
    {
        return m_uFoodInStock;
    };
    u16 getProdPerTurn();
    u16 getProdInStock()
    {
        return m_uProdInStock;
    };
    u8 getUnitProdInStock()
    {
        return m_uUnitProdInStock;
    };
    Building * getCurrentBuilding();
    void setCurrentBuilding(const char * sName);
    Ethnicity::TownUnit * getCurrentUnit()
    {
        return m_pCurrentBuildingUnit;
    };
    void setCurrentUnit(Ethnicity::TownUnit * pUnit);

    // List access
    ObjectList * getBuildingsList()
    {
        return m_pBuildings;
    };

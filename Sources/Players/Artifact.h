...
{
public:
    ArtifactEffect_Charac(const char * sKey, int iMod)
    {
...
{
public:
    ArtifactEffect_Spell(const char * sEdition, const char * sName)
    {
...
{
public:
    ArtifactEffect_Skill(const char * sEdition, const char * sName, const char * sParams)
    {
...
public:
    ...
    void addArtifactEffect(ArtifactEffect * pEffect)
    {
        m_pEffects->addLast(pEffect);
    };
    ObjectList * getArtifactEffects()
    {
        return m_pEffects;
    };
    char * getTexture()

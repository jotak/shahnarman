...
public:
    ...
    char * getResolveParameters()
    {
        return m_sResolveParameters;
    };
    ...
    bool isAllowedInBattle()
    {
        return m_bAllowedInBattle;
    };
    bool isGlobal()
    {
        return m_bGlobal;
    ...
    void setTargetInfo(char * sInfos)
    {
        wsafecpy(m_sTargetInfo, 256, sInfos);
    };
    char * getTargetInfo()
    {
        return m_sTargetInfo;
    };

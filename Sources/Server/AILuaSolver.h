...
public:
    ...
    {
    public:
        EvaluationTargetInfo(u8 uTargetType, u32 uConstraints)
        {
            m_uTargetType = uTargetType;
            m_uConstraints = uConstraints;
            it1 = it2 = 0;
        };
        u8 m_uTargetType;
        u32 m_uConstraints;
...
protected:
    void addEvaluationTarget(EvaluationTargetInfo * pEval)
    {
        m_pEvaluationTargets->addLast(pEval);
    };
    void addInterestForCurrentSpell(float fInterest)
    {
        m_fCurrentInterest += fInterest;
    };

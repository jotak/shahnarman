...
public:
    ...
    virtual void setXPos(int iXPxl)
    {
        m_iXPxl = iXPxl;
    };
    virtual void setYPos(int iYPxl)
    {
        m_iYPxl = iYPxl;
    };
    ...
    void setTooltipText(const char * sTooltip)
    {
        wsafecpy(m_sTooltip, 256, sTooltip);
    };

    // Other
    F_RGBA  getDiffuseColor()
    {
        return m_DiffuseColor;
    };
    void setDiffuseColor(F_RGBA color)
    {

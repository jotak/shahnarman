...
public:
    ...
    virtual u32 getType()
    {
        return guiComponent::getType() | GOTYPE_BUTTON;
    };
    ...
    {
        m_pLabel->setFontId(id);
    };
    void setTextColor(F_RGBA textColor)
    {
        m_pLabel->setDiffuseColor(textColor);
    };
    BtnClickOptions getClickOption()
    {
        return m_ClickOption;
    };
    BtnClickOptions getOverOption()
    {
        return m_OverOption;
    };
    void setClickOption(BtnClickOptions clickOption)
    {
        m_ClickOption = clickOption;
    };
    void setOverOption(BtnClickOptions overOption)
    {
        m_OverOption = overOption;
    };
    GeometryQuads * getClickedGeometry()
    {
        return m_pGeometryClicked;
    };
    GeometryQuads * getOverGeometry()
    {
        return m_pGeometryOver;
    };
    GeometryQuads * getNormalGeometry()
    {
        return m_pGeometryNormal;
    };
    void setCatchButton2Events(bool bCatch)
    {
        m_bCatchButton2Events = bCatch;
    };
    void setCatchDoubleClicks(bool bCatch)
    {
        m_bCatchDoubleClicks = bCatch;
    };
    void setMultiClicks(bool bMulti)
    {
        m_bMultiClicks = bMulti;
    };

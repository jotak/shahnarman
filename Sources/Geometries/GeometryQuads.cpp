...
//  Constructor
// -----------------------------------------------------------------
QuadData::QuadData(int xstart, int xend, int ystart, int yend, wchar_t * texture, DisplayEngine * pDisplay)
{
  m_pDisplay = pDisplay;
...
//  Constructor
// -----------------------------------------------------------------
QuadData::QuadData(int xstart, int xend, int ystart, int yend, int ustart, int uend, int vstart, int vend, wchar_t * texture, DisplayEngine * pDisplay)
{
  m_pDisplay = pDisplay;
  Coords3D d3start = pDisplay->get3DCoords(CoordsScreen(xstart, ystart), DMS_2D);
  Coords3D d3end = pDisplay->get3DCoords(CoordsScreen(xend, yend), DMS_2D);
...
//  Constructor
// -----------------------------------------------------------------
QuadData::QuadData(float xstart, float xend, float ystart, float yend, wchar_t * texture, DisplayEngine * pDisplay)
{
  m_pDisplay = pDisplay;
  m_fXStart = xstart;
  m_fYStart = ystart;
...
//  Constructor
// -----------------------------------------------------------------
QuadData::QuadData(float xstart, float xend, float ystart, float yend, int ustart, int uend, int vstart, int vend, wchar_t * texture, DisplayEngine * pDisplay)
{
  m_pDisplay = pDisplay;
  m_fXStart = xstart;
  m_fYStart = ystart;

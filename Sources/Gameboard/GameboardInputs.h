...
public:
  ...
  GameboardMouseMode getMouseMode() { return m_MouseMode; };

  // Member access functions
  MapObject * getSelectedMapObject() { return m_pSelectedMapObj; };
  void setSelectedMapObject(MapObject * mapObj) { m_pSelectedMapObj = mapObj; };

...
public:
    ...
    virtual u32 getType()
    {
        return guiComponent::getType() | GOTYPE_CONTAINER;
    };
    ...
    // Document management
    virtual guiDocument * getDocument()
    {
        return m_pDoc;
    };
    ...
    // Member access
    FrameFitBehavior getWidthFitBehavior()
    {
        return m_WidthFit;
    };
    FrameFitBehavior getHeightFitBehavior()
    {
        return m_HeightFit;
    };
    void setWidthFitBehavior(FrameFitBehavior widthFit)
    {
        m_WidthFit = widthFit;
    };
    void setHeightFitBehavior(FrameFitBehavior heightFit)
    {

...
public:
    ...
    InfoboxDlg * getInfoDialog()
    {
        return m_pInfoWnd;
    };
    ResolveDlg * getResolveDialog()
    {
        return m_pResolveWnd;
    };
    SpellDlg * getSpellDialog()
    {
        return m_pSpellWnd;
    };
    MapObjectDlg * getMapObjectDialog()
    {
        return m_pMapObjectWnd;
    };
    GameOverDlg * getGameOverDialog()
    {
        return m_pGameOverWnd;
    };
    UnitOptionsDlg * getUnitOptionsDialog()
    {
        return m_pUnitOptionsWnd;
    };
    StatusDlg * getStatusDialog()
    {
        return m_pStatusWnd;
    };
    GeometryQuads * getMenuBackground()
    {
        return m_pMenuBgGeometry;
    };
    ...
    // Menu functions
    StartMenuDlg * getStartMenuDialog()
    {
        return m_pStartMenuWindow;
    };
    LoadGameDlg * getLoadGameDialog()
    {
        return m_pLoadGameWnd;
    };
    SelectPlayerAvatarDlg * getSelectPlayerDialog()
    {
        return m_pSelectPlayerAvatarWnd;
    };
    BuildDeckDlg * getBuildDeckDialog()
    {
        return m_pBuildDeckWnd;
    };
    ArtifactsEquipDlg * getArtifactsEquipDialog()
    {
        return m_pArtifactsEquipWnd;
    };
    ShopDlg * getShopDialog()
    {
        return m_pShopWnd;
    };
    HostGameDlg * getHostGameDialog()
    {
        return m_pHostGameWnd;
    };
    LevelUpDlg * getLevelUpDialog()
    {
        return m_pLevelUpWnd;
    };
    OptionsDlg * getOptionsDialog()
    {
        return m_pOptionsWnd;
    };
    SpellsSelectorDlg * getSpellsSelectorDialog()
    {
        return m_pSpellsSelectorWnd;
    };
    PlayerSelectorDlg * getPlayerSelectorDialog()
    {
        return m_pPlayerSelectorWnd;
    };
    CreateAvatarDlg * getCreateAvatarDlg()
    {
        return m_pCreateAvatarDlg;
    };
